...
/* 22 */ codeSlide({
  ...
  code: [
    ...
    "",
    "-> aidlc/intent.md",
    "   “...if I enter an amplitude",
    "    of 1.0, the chart shows 1.0.”",
  ].join("\n"),
  paras: [
    "Four questions, answered in your own words. There is no prompt for this one — an agent cannot tell you who your app is for.",
    "The fourth question is the one that earns its place. Nothing told the Round 1 agent where to stop, so it invented scope; this is where you stop it.",
  ],
...
/* 23 */ codeSlide({
  ...
  code: [
    ...
    "  Read tests/test_spectrum.py.",
    "  WRITE aidlc/requirements.md:",
    "  a numbered table, each row",
    "  carrying a check that can",
    "  be run.",
    "",
  ...
  paras: [
    ...
    "Row 2 is the whole lab. The failure Round 1 could not see is now a numbered line in a document — written down before any code exists to get it wrong.",
  ],
...
/* 24 */ codeSlide({
  ...
  code: [
    ...
    "  WRITE design.md and tasks.md.",
    "  Exactly two tasks. One owner,",
    "  one file per row.",
    "",
    "-> aidlc/tasks.md",
    "   | 1 | core/spectrum.py |",
  ...
  paras: [
    "Design, plus a task list where every task names the ONE file it may touch. Working alone that looks like bookkeeping.",
    "In Session 2 it is the whole trick: four people build at once, never touch the same file, and there is nothing to merge.",
  ],
  prompt: "You are approving a plan, not code. No code exists yet.",
...
/* 25 */ codeSlide({
  ...
  code: [
    ...
    "  OVERWRITE core/spectrum.py.",
    "  Then run pytest and paste",
    "  the output verbatim.",
    "",
    "-> core/spectrum.py",
    "   $ pytest  ->  7 passed",
  ...
  paras: [
    "One task, one file, tests run, diff read, commit. Never three tasks at once — when something breaks you want one small change in front of you.",
